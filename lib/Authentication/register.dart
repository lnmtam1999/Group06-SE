...
class _RegisterState extends State<Register>
{
  ...
  final TextEditingController _cPasswordTextEdittingController = TextEditingController();
  ...
  Future<void> uploadAndSaveImage() async{
    if(_imageFile==null){
      ...
      _passwordTextEdittingController.text == _cPasswordTextEdittingController.text
          ...
          : displayDialog("Please fill up the registration compelete form..")
